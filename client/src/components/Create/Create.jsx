...
import { Link, useNavigate } from "react-router-dom";
  ...
  const validate = (input) => {
    let errors = {};
    if (input.name === "") {
      errors.name = "field to complete";
    }
    if (input.category === "") {
      errors.category = "field to complete";
    }
    if (input.description === "") {
      errors.description = "field to complete";
    }
    if (input.price === "") {
      errors.price = "field to complete";
    }
    if (input.material === "") {
      errors.material = "field to complete";
    }
    if (input.activity === "") {
      errors.activity = "field to complete";
    }
    if (input.brand === "") {
      errors.brand = "field to complete";
    }
    if (input.model === "") {
      errors.model = "field to complete";
    }
    ...
    <header>
      ...
      <div className="pets-weight">
        ...
        <div className="radio-container">
          ...
          <input id="tshirt" name="category" value="t-shirts" type="radio" onClick={(e)=>handleClickCategory(e)}></input>
      ...
      <div className="set">
        ...
        <div className="pets-spayed-neutered">
          ...
          {errors.material ? <p className="danger">{errors.material}</p> : null}
      ...
      <div className="set">
        <div className="pets-gender">
          ...
          <div className="radio-container">
          <input id="pets-birthday" placeholder="Price" name="price" value={input.price} type="number" onChange={(e) => handleChange(e)}></input>
          </div>
